...
const projects = [
  ...
  },
  {
    ...
    description:
      'The phone app for a smart kettle whose manufacturer went under, live on the App Store and Google Play. Finds, pairs and boils entirely over your own Wi-Fi, with no account and no cloud, and politely shares the kettle’s single connection between phones.',
