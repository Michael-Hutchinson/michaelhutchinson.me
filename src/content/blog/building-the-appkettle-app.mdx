...
date: '2026-05-15'
tags: ['TypeScript', 'Smart Home']
published: true
---

_Update, September 2026: this app is now [Kettle Remote](https://kettle.michaelhutchinson.me), free on the [App Store](https://apps.apple.com/gb/app/kettle-remote/id6797603910) and [Google Play](https://play.google.com/store/apps/details?id=com.michaelhutchinson.kettleremote)._
...
The app is Android-only for now, but I wanted to leave the door open for iOS later without starting from scratch. I'm a JavaScript developer, so React Native made sense.
